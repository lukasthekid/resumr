...
export function ApplicationDetailPanel({
  ...
  return (
    <>
      ...
      <div
        className={[
          "fixed inset-y-0 right-0 w-full max-w-md h-[100dvh] sm:h-full bg-white shadow-2xl z-50",
      ...
      >
        ...
        {/* Footer Actions */}
        <div className="px-4 sm:px-6 py-4 border-t border-slate-200 space-y-2">
          <Link
